        ...
        <div class="row">
            <div class="col-lg-4 offset-lg-4 col-sm-6 offset-sm-3 col-xs-10 offset-xs-1 mt-5 ">
                ...
                <div class="login-content">
                    ...
                    <vue-form v-show = "counter === 1" :state="formstate1" @submit.prevent="onSubmit(2)"  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <validate tag="div">
                                        ...
                                        <field-messages name="password" show="$invalid && $submitted" class="text-danger">
                                            ...
                                            <div slot="maxlength">Password should be almost 10 characters long</div>
                                        </field-messages>
                                    </validate>
                                </div>
                                <div class="form-group">
                    ...
                    <vue-form v-show = "counter === 2" :state="formstate2" @submit.prevent="onSubmit(3)">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body r-content">
                                ...
                                <div class="form-group">
                                    <validate tag="div">
                                        <b-form-select
                                                ...
                                                value-field="item"
                                                text-field="name"
                                                class="mb-3 r-content form-control select-option-reg"
                                                name = "gender"
                                                id = "gender"
                                                required
                                ...
                                <div class="form-group">
                                    <validate tag="div">
                                        <input type="text" v-model="model.nationality" name = "nationality"  id = "nationality" class="form-control r-content national-reg" required placeholder="Nationality"/>
                                ...
                                <div class="form-group">
                                    <validate tag="div">
                                        <b-form-textarea
                                                ...
                                                class="r-content details-reg-pass"
                    ...
                    <div v-show = "counter === 3">
                        <div  class="panel panel-info" >
                            ...
                            <div class="panel-body r-content">
                                    <div class="p-3 bg-white shadow rounded-lg" style="text-align: center">
                                        <input type="file" name="image" required accept="image/*" @change="setImage" /><br>
                                        <img :src="model.croppedImageSrc" width="100" />
...
<!--                                        <button v-if="imageSrc" class="btn btn-info btn-sm" @click="cropImage">Crop</button>-->
                                ...
                                <div class="pull-right   r-content">
                                    <button type="submit" class="btn btn-primary finish-btn"  @click="submit_profile">Finish</button> &nbsp;
                                </div>
                            </div>
                        </div>
                        <h1></h1>
            ...
            setImage: function (e) {
                ...
                if (typeof FileReader === 'function') {
                    ...
                    reader.onload = (event) => {
                      ...
                      this.model.croppedImageSrc = event.target.result;
                      console.log('user image',this.model.croppedImageSrc)
                    };
