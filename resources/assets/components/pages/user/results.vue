        ...
        <div class="row">
          <div class="col-md-4" style="display:flex;">
            <div class="select-date">
              ...
              <input type="date" class="form-control" ref="from" :value="model.from" id="from">
            </div>
          </div>
          <div class="col-md-4">
            <div class="select-date">
              <span class="select-date-txt">To</span>
              <input type="date" class="form-control" placeholder="From" ref="to" :value="model.to" id="to">
            </div>
          </div>
          <div class="col-md-4">
...
export default {
  ...
  methods: {
    ...
    getResult(){
      ...
      User_ApiService.post('GetResult', this.model).then(
          result=>{
