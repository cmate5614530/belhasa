    ...
    <div  v-if="arabic == 0">
      <div v-if="page_language == 'ar-ar' || page_language == 'ur-ur' || page_language == 'fa-fa'" style="direction: rtl;">
        ...
        <table class="table hea">
          ...
          <tr>
            <th>{{$t('table.test_duration')}}</th>
            <td style="    direction: initial; text-align: right;">{{test_min}}  {{test_sec}}</td>
          </tr>
          <tr>
            <th>{{$t('testconfigure.duration')}}</th>
            <td style=" direction: initial; text-align: right;">{{testConfigData.duration}} min</td>
          </tr>
          </tbody>
        </table>
        <table class="table hea">
      ...
      <div v-else>
        ...
        <table class="table hea">
          ...
          <tr>
            <th>{{$t('table.test_duration')}}</th>
            <td style=" ">{{test_min}}  {{test_sec}}</td>
          </tr>
          <tr>
            <th>{{$t('testconfigure.duration')}}</th>
            <td style=" ">{{testConfigData.duration}} min</td>
          </tr>
          </tbody>
        </table>
        <table class="table hea">
