...
<!--                          <img class="ml-2 bg-light " :src="croppedImageSrc"/>-->
<!--                        </div>-->
<!--                        <button v-if="imageSrc" class="btn btn-info btn-sm" @click="cropImage">Crop</button>-->
<!--                      </div>-->
<!--                    </div>-->
<!--                  </div>-->
<!--                </div>-->
...
<!--                <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="cancelQuestionImage">Close</button>-->
<!--                <button type="button" class="btn btn-primary" data-dismiss="modal" @click="saveQuestionImage">Save changes</button>-->
<!--              </div>-->
<!--            </div>-->
<!--          </div>-->
<!--        </div>-->
...
<!--                        <img :src="model.questionImage1" width="100" />-->
<!--                        <div v-if="imageSrc1" class="my-3 d-flex align-items-center justify-content-center mx-auto">-->
<!--                          <vue-cropper class="mr-2 w-50 cropped-image" ref='cropper' :guides="true" :src="imageSrc1"></vue-cropper>-->
<!--                          <img class="ml-2 w-50 bg-light" :src="croppedImageSrc1"/>-->
<!--                        </div>-->
<!--                        <button v-if="imageSrc1" class="btn btn-info btn-sm" @click="cropImage_choice(indexModal)">Crop</button>-->
<!--                      </div>-->
<!--                    </div>-->
<!--                  </div>-->
<!--                </div>-->
...
<!--                        <img :src="imageSrc2" width="100" />-->
<!--                        <div v-if="imageSrc2" class="my-3 d-flex align-items-center justify-content-center mx-auto">-->
<!--                          <vue-cropper class="mr-2 w-50 cropped-image" ref='cropper' :guides="true" :src="imageSrc2"></vue-cropper>-->
<!--                          <img class="ml-2 w-50 bg-light" :src="croppedImageSrc2"/>-->
<!--                        </div>-->
<!--                        <button v-if="imageSrc2" class="btn btn-info btn-sm" @click="cropImage_choice(indexModal)">Crop</button>-->
<!--                      </div>-->
<!--                    </div>-->
<!--                  </div>-->
<!--                </div>-->
...
<!--                        <img :src="imageSrc3" width="100" />-->
<!--                        <div v-if="imageSrc3" class="my-3 d-flex align-items-center justify-content-center mx-auto">-->
<!--                          <vue-cropper class="mr-2 w-50 cropped-image" ref='cropper' :guides="true" :src="imageSrc3"></vue-cropper>-->
<!--                          <img class="ml-2 w-50 bg-light" :src="croppedImageSrc3"/>-->
<!--                        </div>-->
<!--                        <button v-if="imageSrc3" class="btn btn-info btn-sm" @click="cropImage_choice(indexModal)">Crop</button>-->
<!--                      </div>-->
<!--                    </div>-->
<!--                  </div>-->
<!--                </div>-->
...
<!--        </div>-->
        ...
        <vue-form :state="formstate1" @submit.prevent="onSubmit()">
          <div class="card-body">
            <div v-for="(query, index) in model.queries">
              <div class="child-item">
                <div class="close-trans"  >
                  <button v-if="index" class="btn btn-danger btn-sm close-translation logMe" @click="delete_row(index, query.question_translate_id)">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div>
                      <img v-if="!index" class=" bg-light" :src="model.photo" style="width: 200px; margin-bottom: 10px"/><br>
                      <input v-if="!index" type="file" name="image" required accept="image/*" @change="setImage"/>
                    </div>
                  </div>
                </div><br><br>
                  ...
                  <table class="table table-striped">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <audio v-if="query.audio" controls><source :src="query.audio" type="audio/mpeg"></audio>
                  ...
                  <table class="table table-striped">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <input v-if="!index" type="file" name="image" required accept="image/*" @change="setImage1"/>
                        <img v-if="!index" class="  bg-light" :src="model.choice1photo" style="width: 100px; margin-top: 10px"/>

                      </td>
                      <td>
                        <label>Choose new audio:</label>
                        <input type="file" accept="audio/mp3" :id = "index" name = 0 v-on:change="onFileChangeOption">
                        <audio controls v-if="query.option1audio"><source :src="query.option1audio" type="audio/mpeg"></audio>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <input v-if="!index" type="file" name="image" required accept="image/*" @change="setImage2"/>
                        <img v-if="!index" class=" bg-light" :src="model.choice2photo" style="width: 100px;margin-top: 10px"/>

                      </td>
                      <td>
                        <label>Choose new audio:</label>
                        <input type="file" accept="audio/mp3" :id = "index" name = 1 v-on:change="onFileChangeOption">
                        <audio controls v-if="query.option2audio"><source :src="query.option2audio" type="audio/mpeg"></audio>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <input v-if="!index" type="file" name="image" required accept="image/*" @change="setImage3"/>
                        <img v-if="!index" class="  bg-light" :src="model.choice3photo" style="width: 100px;margin-top: 10px"/>

                      </td>
                      <td>
                        <label>Choose new audio:</label>
                        <input type="file" accept="audio/mp3" :id = "index" name = 2 v-on:change="onFileChangeOption">
                        <audio controls v-if="query.option3audio"><source :src="query.option3audio" type="audio/mpeg"></audio>
  ...
  methods: {
    ...
    onSubmit(){
      ...
      if (this.formstate1.$invalid) {
        ...
        Admin_ApiService.post('QuestionUpdate', this.model).then(
            result => {
            ...
            error => {
              ...
              // this.model.queries = [];
              // this.model.queries.push(obj)
              miniToastr.error('Question update is failed')
            }
        )
      }
    ...
    delete_row(index, deletedTranslateID) {
    ...
    Admin_ApiService.post('GetQuestionTransData', this.model).then(
        result => {
          ...
          if (data.success) {
            ...
            this.model.queries = data.transData;
            console.log('--', this.model.queries);
            this.model.photo = data.transData[0].photo;
            this.model.choice1photo = data.transData[0].choice1photo;
            this.model.choice2photo = data.transData[0].choice2photo;
            this.model.choice3photo = data.transData[0].choice3photo;
            this.model.topicArea = data.transData[0].topicArea;
            this.model.answer = data.transData[0].answer;
            this.model.id = data.transData[0].id;
