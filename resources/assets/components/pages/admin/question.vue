        ...
        <div> <br><br>
            <div class="col-lg-12 mb-3">
              <div class="text-right">
                <a :href="'#/admin/add-question/'+ model.category_id+ '/'+ model.test_type"><button class="btn btn-primary"><i class="fa fa-pencil"></i> Add Question</button></a>
                <a :href="'#/admin/bulk-import/'+ model.category_id+ '/'+ model.test_type"><button class="btn btn-primary"><i class="fa fa-pencil"></i> Bulk import</button></a>
              </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr v-for = "(item, index) in response">
                                    ...
                                    <td class="action">
                                        <a :href="'#/admin/question-management-edit/'+item.id+'/'+model.category_id+'/'+model.test_type">
                                            <button class="btn btn-primary btn-sm">
                                            <i class="material-icons">edit</i> Edit</button>
                                        </a>
                                        <button class="btn btn-danger btn-sm" @click="delete_question(item.id, index)">
    ...
    export default {
        ...
        methods: {
            delete_question(id, index){
              ...
              Admin_ApiService.post('DeleteQuestion', {deletequestionid: id}).then(
                  result=>{
                    let data=result.data;
                    if(data.success){
