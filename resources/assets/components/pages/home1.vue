      ...
      <div class="full-width-modal" v-if="pageIndex == 'testStart'">
        ...
        <div class="full-modal-body" v-if="questions.length>0">
          ...
          <div class="question-text audio-section" @click.prevent="question.isPlaying0 ? play(question, 0) : pause(question, 0)">
            ...
            <span class="question-text" style="" v-if="!question.isPlaying0 && this.$store.state.customer_option.audio_language == ''">{{question.question}}</span>
          </div>
      ...
      <div class="full-width-modal" v-if="pageIndex == 'ReviewUnanswered'">
        ...
        <div class="full-modal-body" v-if="questions.length>0">
          ...
          <div class="question-text audio-section" @click.prevent="questions[current_question_number].isPlaying0 ? play(questions[current_question_number], 0) : pause(questions[current_question_number], 0)">
            ...
            <span class="question-text" style="" v-if="!questions[current_question_number].isPlaying0 && this.$store.state.customer_option.audio_language == ''">{{questions[current_question_number].question}}</span>
          </div>
          <div class="question-choice-container">
            <table>
              <tr class="question-choice-item-wrapper">
      ...
      <div class="full-width-modal" v-if="pageIndex == 'ReviewUnanswered'">
        ...
        <div class="full-modal-body" v-if="questions.length>0">
          ...
          <div class="question-text audio-section" @click.prevent="questions[current_question_number].isPlaying0 ? play(questions[current_question_number], 0) : pause(questions[current_question_number], 0)">
            <span class="question-text" v-if="questions[current_question_number].isPlaying0">{{questions[current_question_number].question}}</span>
            <span class="question-text" style="color:#ff0000;" v-if="!questions[current_question_number].isPlaying0 && this.$store.state.customer_option.audio_language >0">{{questions[current_question_number].question}}</span>
            <span class="question-text" v-if="!questions[current_question_number].isPlaying0 && this.$store.state.customer_option.audio_language == ''">{{questions[current_question_number].question}}</span>
          </div>
...
export default {
  ...
  methods:{
    ...
    review(){
      if(this.$store.state.customer_option.audio_language && this.questions[this.current_question_number]['audio']){
    ...
    reviewAll(){
      ...
      //audio player
      if(this.$store.state.customer_option.audio_language && this.questions[0]['audio']){
    ...
    ReviewUnansweredNextQuestion(){
      ...
      if(this.unansweredQuestionStartNum == this.reviewUnansweredQuestion.length){
        ...
        //audio- player
        if(this.$store.state.customer_option.audio_language && this.questions[this.current_question_number-1]['audio']){
    ...
    ReviewUnansweredPreviousQuestion(){
      ...
      if(this.unansweredQuestionStartNum>=0){
        ...
        if(this.$store.state.customer_option.audio_language && this.question['audio']){
...
//console.log('----customer_option---', customer_option);
    ...
    saveAnswer(){
console.log("@@@@@@@@@@@saveAnswer@@@@@", this.testConfig.noofquestion)

      var testResultData = this.$store.state.testResultsArray;
      if(testResultData.length < this.testConfig.noofquestion){
        //console.log('this.form_choice',this.form_choice)
        // console.log('this.questions[this.current_question_number-1].answer',this.questions[this.current_question_number-1].answer)
        ...
        if(this.$store.state.testResultsArray){
          ...
          this.$store.commit('testResults',[])                //====>testResults(state,question){ state.testResultsArray = question },
          var testResultData = this.$store.state.testResultsArray;
        }
        ...
        // }
        this.first_testResult  = this.$store.state.testResultsArray;
        console.log('------this.testResultsArray', testResultData);
      }
    ...
    saveAnswerStatus(){
      var testResultData = this.$store.state.testResultsArray;
      console.log('this.form_choice1',this.form_choice)
      console.log('this.questions[this.current_question_number-1]',this.questions[this.current_question_number-1])
      console.log('this.questions[this.current_question_number-1].answer1',this.questions[this.current_question_number-1].answer)

      this.question_check(this.form_choice, this.questions[this.current_question_number].answer);
    ...
    previousQuestion(){
      ...
      if(this.$store.state.customer_option.audio_language && typeof this.question['audio']!='undefined'){
