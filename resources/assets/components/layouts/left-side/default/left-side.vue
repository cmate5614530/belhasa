...
<!--         <aside data-background-color="black" class="left-aside sidebar-offcanvas bk-img-black" style="background-image: url(~img/left-side-bk.PNG);">-->
         <aside data-background-color="black" class="left-aside sidebar-offcanvas bk-img-black" style="position: absolute; background-image: url(resources/assets/assets/img/left-side-bk.PNG);">
             <div>
