        ...
        <nav>
            ...
            <div class="navbar-right" style="margin-top: -10px" >
                <div>
                    ...
                    <b-dropdown v-if="this.$store.state.user.isAdmin == 1" class="user user-menu bell_bg user_btn" right link>
                        <span slot="text">
                        ...
                        <a :href="'#/admin/users/edit/' + this.$store.state.user.id" v-if="checkAdmin == 1" class="dropdown-item dropdown_content" style="padding: 10px">
                            &nbsp;&nbsp;<i class="fa fa-user-o"></i> &nbsp;Profile
                        </a>
                        <a :href="'#/users/edit/' + this.$store.state.user.id" v-if="checkAdmin == 0"  class="dropdown-item dropdown_content" style="padding: 10px">
                            &nbsp;&nbsp;<i class="fa fa-user-o"></i> &nbsp;{{$t('home.menu.profile')}}
                        </a>
                  ...
                  <b-dropdown v-else class="user user-menu bell_bg user_btn" right link>
                        <span slot="text">
                            <img :src="this.$store.state.user.photo" class="rounded-circle" alt="User Image">
                          <!-- User name-->
                            <p class="user_name_max">{{this.$store.state.user.name}}</p>
                        </span>
                    <a :href="'#/users/edit/' + this.$store.state.user.id" class="dropdown-item dropdown_content" style="padding: 10px">
                      &nbsp;&nbsp;<i class="fa fa-user-o"></i> &nbsp;{{$t('home.menu.profile')}}
                    </a>
                    <b-dropdown-item exact class="dropdown_content">
                      <a href="javascript:void(0)" exact class="drpodowtext" @click.stop.prevent="logout">
                        <i class="fa fa-sign-out"></i> {{$t('home.menu.logout')}}
                      </a>
                    </b-dropdown-item>
                  </b-dropdown>
                </div>
