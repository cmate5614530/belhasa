let mutations = {
    ...
    supervisoridBylogin(state,id){
        state.supervisoridBylogin=id;
    },
    testConfigData(state,testConfigData){
        state.testConfigData=testConfigData;
    },
    fullTestConfigData(state,fullTestConfigData){
        state.fullTestConfigData=fullTestConfigData;
    },
    testResults(state,question){
        state.testResultsArray = question;
    },
    testResultsForRePrint(state,testResultsForRePrint){
        state.testResultsForRePrint = testResultsForRePrint;
    },
    Logout(state,question){
    ...
    testMinute(state,minute){
        state.testMinute = minute;
    },
    testSecond(state,second){
