...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_awesome_swiper__ = __webpack_require__(837);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_admin_api_service__ = __webpack_require__(810);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_tables_2__ = __webpack_require__(844);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_plugins_DataTable_DataTable__ = __webpack_require__(831);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_mini_toastr__ = __webpack_require__(808);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_common_user_api_service__ = __webpack_require__(997);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    nextQuestion: function nextQuestion() {
      ...
      if (this.form_choice == '') {
        __WEBPACK_IMPORTED_MODULE_5_mini_toastr__["a" /* default */].error('Please choose your answer');
      } else {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "section-title" }, [_vm._v("Welcome !")]),
      _vm._v(" "),
      _c("div", { staticClass: "note-description-wrapper m-5 text-center" }, [
        ...
        _vm.showSelectionPractise == 1
          ? _c("div", { staticClass: "row" }, [
              _c(
                "div",
                {
                  staticClass: "col-lg-6 col-md-6 col-sm-12 practise_common",
                  on: {
                    click: function($event) {
                ...
                [_c("i", { staticClass: "fa fa-shield" }), _vm._v(" Common")]
              ),
              _vm._v(" "),
              _c(
                "div",
                {
                  staticClass: "col-lg-6 col-md-6 col-sm-12 practise_specific",
                  on: {
                    click: function($event) {
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "modal-body modal-text" }, [
      _c("h3", [
        _vm._v(
          "This is for practice purpose only and It doesn't represent actual theory test."
        )
      ]),
      _c("br")
    ])
...
var Pagination = __webpack_require__(846);
var PaginationEvent = __webpack_require__(812);
...
var _merge = _interopRequireDefault(__webpack_require__(804));
...
var methods = __webpack_require__(852);

var computed = __webpack_require__(912);

var beforeDestroy = __webpack_require__(925);
...
var is_empty = __webpack_require__(926);

var registerVuexModule = __webpack_require__(927);
...
module.exports = function (template, theme) {
  var themes = {
    bootstrap3: __webpack_require__(930)(),
    bootstrap4: __webpack_require__(931)(),
    bulma: __webpack_require__(932)()
  };
  var templates = {
    "default": __webpack_require__(933),
    footerPagination: __webpack_require__(934)
  };
  return function (h) {
    var modules = {
      rows: __webpack_require__(935).call(this, h),
      normalFilter: __webpack_require__(937).call(this, h),
      dropdownPagination: __webpack_require__(938).call(this, h),
      dropdownPaginationCount: __webpack_require__(939).call(this, h),
      columnFilters: __webpack_require__(940).call(this, h),
      pagination: __webpack_require__(944).call(this, h),
      headings: __webpack_require__(945).call(this, h),
      perPage: __webpack_require__(947).call(this, h),
      columnsDropdown: __webpack_require__(948).call(this, h)
    };
    ...
    var slots = __webpack_require__(951).call(this);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(839).Buffer))
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fuse_js__ = __webpack_require__(835);
...
var isArray = __webpack_require__(842)
...
var _bus = _interopRequireDefault(__webpack_require__(805));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

var ClientTable = __webpack_require__(845);

var ServerTable = __webpack_require__(962);
...
var _vuePagination = __webpack_require__(811);

var _vuex = _interopRequireDefault(__webpack_require__(813));

var _normal = _interopRequireDefault(__webpack_require__(814));

var _merge = _interopRequireDefault(__webpack_require__(804));

var _table = _interopRequireDefault(__webpack_require__(815));

var _data2 = _interopRequireDefault(__webpack_require__(819));

var _resizeableColumns = _interopRequireDefault(__webpack_require__(820));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

var _data = __webpack_require__(821);

var _created = __webpack_require__(822);

var templateCompiler = __webpack_require__(823);
...
exports.install = function (Vue, globalOptions, useVuex) {
  ...
  var client = _merge["default"].recursive(true, (0, _table["default"])(), {
    ...
    computed: {
      q: __webpack_require__(952),
      customQ: __webpack_require__(953),
      totalPages: __webpack_require__(826),
      filteredData: __webpack_require__(954),
      hasMultiSort: function hasMultiSort() {
        return this.opts.clientMultiSorting;
      }
    },
    methods: {
      transformDateStringsToMoment: __webpack_require__(955),
      registerClientFilters: __webpack_require__(956),
      search: __webpack_require__(957),
      defaultSort: __webpack_require__(960),
      getGroupSlot: __webpack_require__(961),
...
var _config = __webpack_require__(847);

var _config2 = _interopRequireDefault(_config);

var _merge = __webpack_require__(804);
...
var bus = __webpack_require__(812);
...
module.exports = {
  ...
  computed: {
    ...
    Theme: function Theme() {
      ...
      var themes = {
        bootstrap3: __webpack_require__(849),
        bootstrap4: __webpack_require__(850),
        bulma: __webpack_require__(851)
      };
...
module.exports = {
  initQuery: __webpack_require__(853),
  resetQuery: __webpack_require__(854),
  initCustomFilters: __webpack_require__(855),
  initOptions: __webpack_require__(856),
  sortableClass: __webpack_require__(857),
  sortableChevronClass: __webpack_require__(858),
  display: __webpack_require__(859),
  orderByColumn: __webpack_require__(860),
  getHeading: __webpack_require__(861),
  getHeadingTooltip: __webpack_require__(863),
  sortable: __webpack_require__(864),
  serverSearch: __webpack_require__(816),
  initOrderBy: __webpack_require__(865),
  initDateFilters: __webpack_require__(866),
  setFilter: __webpack_require__(867),
  setPage: __webpack_require__(868),
  setOrder: __webpack_require__(869),
  initPagination: __webpack_require__(870),
  filterable: __webpack_require__(871),
  isTextFilter: __webpack_require__(872),
  isDateFilter: __webpack_require__(873),
  isListFilter: __webpack_require__(874),
  highlightMatch: __webpack_require__(875),
  formatDate: __webpack_require__(876),
  hasDateFilters: __webpack_require__(877),
  applyFilters: __webpack_require__(878),
  optionText: __webpack_require__(879),
  render: __webpack_require__(880),
  rowWasClicked: __webpack_require__(881),
  setLimit: __webpack_require__(882),
  getOpenChildRows: __webpack_require__(883),
  dispatch: __webpack_require__(884),
  toggleChildRow: __webpack_require__(885),
  childRowTogglerClass: __webpack_require__(886),
  sendRequest: __webpack_require__(887),
  getResponseData: __webpack_require__(888),
  getSortFn: __webpack_require__(889),
  initState: __webpack_require__(890),
  updateState: __webpack_require__(891),
  columnClass: __webpack_require__(892),
  getName: __webpack_require__(893),
  toggleColumn: __webpack_require__(894),
  setUserMultiSort: __webpack_require__(895),
  _cellClasses: __webpack_require__(896),
  _setFiltersDOM: __webpack_require__(897),
  _currentlySorted: __webpack_require__(898),
  _getChildRowTemplate: __webpack_require__(899),
  _toggleColumnsDropdown: __webpack_require__(900),
  _onlyColumn: __webpack_require__(901),
  _onPagination: __webpack_require__(902),
  _toggleGroupDirection: __webpack_require__(903),
  _getInitialDateRange: __webpack_require__(904),
  _setDatepickerText: __webpack_require__(905),
  _initialOrderAscending: __webpack_require__(906),
  dateFormat: __webpack_require__(907),
  _setColumnsDropdownCloseListener: __webpack_require__(908),
  _getValue: __webpack_require__(909),
  _getColumnName: __webpack_require__(910),
  _shouldShowColumnOnInit: __webpack_require__(911)
};
...
var _ucfirst = _interopRequireDefault(__webpack_require__(862));
...
var validMoment = __webpack_require__(817);
...
var intersection = __webpack_require__(818)["default"];
...
module.exports = {
  listColumnsObject: __webpack_require__(913),
  allColumns: __webpack_require__(914),
  templatesKeys: __webpack_require__(915),
  opts: __webpack_require__(916),
  tableData: __webpack_require__(918),
  storage: __webpack_require__(919),
  filterableColumns: __webpack_require__(920),
  datepickerColumns: __webpack_require__(921),
  hasChildRow: __webpack_require__(922),
  colspan: __webpack_require__(923),
  hasGenericFilter: __webpack_require__(924),
...
var intersect = __webpack_require__(818)["default"];
...
var _state = _interopRequireDefault(__webpack_require__(928));

var _mutations = _interopRequireDefault(__webpack_require__(929));
...
module.exports = function (h, modules, classes, slots) {
  ...
  var perpageValues = __webpack_require__(824).call(this, h);
...
var _babelHelperVueJsxMergeProps = _interopRequireDefault(__webpack_require__(936));

var _clone = _interopRequireDefault(__webpack_require__(825));
...
module.exports = function (h) {
  ...
  return function (classes) {
    ...
    var textFilter = __webpack_require__(941).call(_this, h, classes.input);

    var dateFilter = __webpack_require__(942).call(_this, h);

    var listFilter = __webpack_require__(943).call(_this, h, classes.select);
...
module.exports = function (h) {
  ...
  return function (right) {
    ...
    var sortControl = __webpack_require__(946)(h, right);
...
var dropdownWrapper = __webpack_require__(949);

var dropdownItemWrapper = __webpack_require__(950);
...
var clone = __webpack_require__(825);
...
var object_filled_keys_count = __webpack_require__(958);

var is_valid_moment_object = __webpack_require__(817);

var filterByCustomFilters = __webpack_require__(959);
...
exports.install = function (Vue, globalOptions, useVuex) {
  ...
  var server = _merge["default"].recursive(true, (0, _table["default"])(), {
    ...
    methods: {
      refresh: __webpack_require__(963),
      getData: __webpack_require__(964),
      setData: __webpack_require__(965),
      serverSearch: __webpack_require__(816),
      registerServerFilters: __webpack_require__(966),
      loadState: function loadState() {
        var _this = this;
    ...
    computed: {
      totalPages: __webpack_require__(826),
      filteredQuery: __webpack_require__(967),
      hasMultiSort: function hasMultiSort() {
