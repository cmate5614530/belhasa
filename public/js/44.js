...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_admin_api_service__ = __webpack_require__(768);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_common_user_api_service__ = __webpack_require__(931);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    nextQuestion: function nextQuestion() {
      ...
      console.log('this.testConfig.noofquestion', this.testConfig.noofquestion);

      if (this.form_choice == '') {
        var please_choose_your_answer = $('#please_choose_your_answer').val();
        __WEBPACK_IMPORTED_MODULE_5_mini_toastr__["a" /* default */].error(please_choose_your_answer);
      } else {
      ...
      if (this.second > 0) {
        setTimeout(function () {
          ...
          if (_this3.second % 60 === 59) {
            _this3.minute -= 1;
            if (_this3.minute < 10) {
              _this3.minute = '0' + _this3.countDown;
            }
          }
  ...
  created: function created() {
    ...
    __WEBPACK_IMPORTED_MODULE_6_common_user_api_service__["a" /* default */].get('testConfig', { category: this.$store.state.customer_option.category }).then(function (result) {
      var data = result.data;
      console.log('testconfig full datassss', data.data);
            ...
            _c(
              ...
              [
                ...
                _c(
                  ...
                  [
                    _vm.showSelectionPractise == 0
                      ? _c(
                          "div",
                          {
                            staticClass:
                              "col-lg-12 col-md-12 col-sm-12 practise_specific_item",
                      ...
                      ? _c("div", { staticClass: "row" }, [
                          _c(
                            ...
                            [
                              ...
                              _vm._v(
                                " " + _vm._s(_vm.$t("testconfigure.common"))
                              )
                            ]
                          ),
                          _vm._v(" "),
