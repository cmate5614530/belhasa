...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_form__ = __webpack_require__(787);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__validations_validations__ = __webpack_require__(786);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_awesome_swiper__ = __webpack_require__(790);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common_admin_api_service__ = __webpack_require__(769);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_tables_2__ = __webpack_require__(802);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_plugins_DataTable_DataTable__ = __webpack_require__(795);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_mini_toastr__ = __webpack_require__(767);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        delete_question: function delete_question(id, index) {
            var _this2 = this;

            __WEBPACK_IMPORTED_MODULE_4__common_admin_api_service__["a" /* default */].post('DeleteQuestion', { deletequestionid: id }).then(function (result) {
                var data = result.data;
                if (data.success) {
            ...
            __WEBPACK_IMPORTED_MODULE_4__common_admin_api_service__["a" /* default */].post('GetQuestions', this.model).then(function (result) {
                ...
                if (data.success) {
                    ...
                    console.log('get questions123', data.response);

                    _this2.response.splice(index, 1);
                }
            }, function (error) {
                console.log('error');
            }).catch(function (error) {
                    ...
                    _c(
                      ...
                      _vm._l(_vm.response, function(item, index) {
                        return _c("tr", [
                          ...
                          _vm._v(" "),
                          _c("td", [
                            _c("p", [_vm._v(_vm._s(item.choice1))]),
                            _vm._v(" "),
                            _c("p", [_vm._v(_vm._s(item.choice2))]),
                            _vm._v(" "),
                            _c("p", [_vm._v(_vm._s(item.choice3))])
                          ]),
                          _vm._v(" "),
                          _c(
                            "td",
                          ...
                          _c("td", { staticClass: "action" }, [
                            ...
                            _c(
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.delete_question(item.id, index)
                                  }
                                }
                              },
                              [
