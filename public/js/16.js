    ...
    data: function data() {
        return {
            ...
            model: {
                ...
                passport_details: "",
                profile_image: "",
                options: [{ item: 'Male', name: 'Male' }, { item: 'Female', name: 'Female' }],
                married_options: [{ value: 'Single', text: 'Single' }, { value: 'Married', text: 'Married' }],
                category: '1',
                CategoryData: [],
                userType: '1',
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("a", { attrs: { href: "#/admin/users" } }, [
